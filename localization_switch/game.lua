...
function Game:start_up()
    ...
    if settings then 
        for k, v in pairs(STR_UNPACK(settings)) do
            self.SETTINGS[k] = v
        end
    end
    ...
    self.sticker_map = {
        'White','Red','Green','Blue','Black','Purple','Orange','Gold'
    }
...
function Game:init_item_prototypes()
    ...
    self.P_TAGS = {
        ...
        tag_standard =      {name = 'Standard Tag',     set = 'Tag', discovered = false, min_ante = nil, order = 10, config = {type = 'new_blind_choice', }, pos = {x = 1,y = 2}},
        tag_charm =         {name = 'Charm Tag',        set = 'Tag', discovered = false, min_ante = nil, order = 11, config = {type = 'new_blind_choice', }, pos = {x = 2,y = 2}},
        tag_meteor =        {name = 'Meteor Tag',       set = 'Tag', discovered = false, min_ante = nil, order = 12, config = {type = 'new_blind_choice', }, pos = {x = 3,y = 2}},
        tag_buffoon =       {name = 'Buffoon Tag',      set = 'Tag', discovered = false, min_ante = 2,   order = 13, config = {type = 'new_blind_choice', }, pos = {x = 4,y = 2}},
        tag_handy =         {name = 'Handy Tag',        set = 'Tag', discovered = false, min_ante = nil, order = 14, config = {type = 'round_start_bonus', hands = 3}, pos = {x = 1,y = 3}},
        tag_garbage =       {name = 'Garbage Tag',      set = 'Tag', discovered = false, min_ante = nil, order = 15, config = {type = 'round_start_bonus', discards = 3}, pos = {x = 2,y = 3}},
        ...
        tag_juggle =        {name = 'Juggle Tag',       set = 'Tag', discovered = false, min_ante = nil, order = 19, config = {type = 'round_start_bonus', h_size = 2}, pos = {x = 5,y = 1}},
    ...
    self.P_STAKES = {
        ...
        stake_blue =    {name = 'Blue Chip',    unlocked = false, order = 4, pos = {x = 3,y = 0}, stake_level = 4, set = 'Stake'},
        stake_black =   {name = 'Black Chip',   unlocked = false, order = 5, pos = {x = 4,y = 0}, stake_level = 5, set = 'Stake'},
    ...
    self.P_BLINDS = {
        ...
        bl_arm =             {name = 'The Arm',      defeated = false, order = 8, dollars = 5, mult = 2,  vars = {}, debuff = {}, pos = {x=0, y=11}, boss = {min = 1, max = 10}, boss_colour = HEX('6865f3')},
        ...
        bl_flint =           {name = 'The Flint',    defeated = false, order = 24, dollars = 5, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=24}, boss = {min = 1, max = 10}, boss_colour = HEX('e56a2f')},
    ...
    self.P_CENTERS = {
        ...
        j_jolly=            {order = 6,  unlocked = true,   discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Jolly Joker", pos = {x=2,y=0}, set = "Joker", effect = "Type Mult", cost_mult = 1.0, config = {t_mult = 8, type = 'Pair'}},
        j_zany=             {order = 7,  unlocked = true,   discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Zany Joker", pos = {x=3,y=0}, set = "Joker", effect = "Type Mult", cost_mult = 1.0, config = {t_mult = 10, type = 'Three of a Kind'}},
        ...
        j_crazy=            {order = 9,  unlocked = true,   discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Crazy Joker", pos = {x=5,y=0}, set = "Joker", effect = "Type Mult", cost_mult = 1.0, config = {t_mult = 15, type = 'Straight'}},
        ...
        j_sly=              {order = 11,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Sly Joker",set = "Joker", config = {t_chips = 40, type = 'Pair'}, pos = {x=0,y=14}},
        j_wily=             {order = 12,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Wily Joker",set = "Joker", config = {t_chips = 70, type = 'Three of a Kind'}, pos = {x=1,y=14}},
        j_clever=           {order = 13,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Clever Joker",set = "Joker", config = {t_chips = 130, type = 'Four of a Kind'}, pos = {x=2,y=14}},
        ...
        j_crafty=           {order = 15,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Crafty Joker",set = "Joker", config = {t_chips = 70, type = 'Flush'}, pos = {x=4,y=14}},

        j_half=             {order = 16,  unlocked = true,   discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Half Joker", pos = {x=7,y=0}, set = "Joker", effect = "Hand Size Mult", cost_mult = 1.0, config = {extra = {mult = 15, size = 3}}},
        ...
        j_four_fingers=     {order = 18,  unlocked = true,  discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = "Four Fingers", pos = {x=6,y=6}, set = "Joker", effect = "", config = {}},
        j_mime=             {order = 19,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Mime", pos = {x=4,y=1}, set = "Joker", effect = "Hand card double", cost_mult = 1.0, config = {extra = 1}},
        j_credit_card=      {order = 20,  unlocked = true,  discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 1, cost = 2, name = "Credit Card", pos = {x=5,y=1}, set = "Joker", effect = "Credit", cost_mult = 1.0, config = {extra = 20}},
        j_ceremonial=       {order = 21,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 8, name = "Ceremonial Dagger", pos = {x=5,y=5}, set = "Joker", effect = "", config = {mult = 0}},
        j_banner=           {order = 22,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Banner", pos = {x=1,y=2}, set = "Joker", effect = "Discard Chips", cost_mult = 1.0, config = {extra = 40}},
        ...
        j_loyalty_card=     {order = 25,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Loyalty Card", pos = {x=4,y=2}, set = "Joker", effect = "1 in 10 mult", cost_mult = 1.0, config = {extra = {Xmult = 4, every = 5, remaining = "5 remaining"}}},
        j_8_ball=           {order = 26,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "8 Ball", pos = {x=0,y=5}, set = "Joker", effect = "Spawn Tarot", cost_mult = 1.0, config = {extra= 2}},
        j_misprint=         {order = 27,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Misprint", pos = {x=6,y=2}, set = "Joker", effect = "Random Mult", cost_mult = 1.0, config = {extra = {max = 20, min = 0}}},
        j_dusk=             {order = 28,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Dusk", pos = {x=4,y=7}, set = "Joker", effect = "", config = {extra = 1}, unlock_condition = {type = '', extra = '', hidden = true}},
        j_raised_fist=      {order = 29,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Raised Fist", pos = {x=8,y=2}, set = "Joker", effect = "Socialized Mult", cost_mult = 1.0, config = {}},
        j_chaos=            {order = 30,  unlocked = true,  discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 1, cost = 5, name = "Chaos the Clown", pos = {x=1,y=0}, set = "Joker", effect = "Bonus Rerolls", cost_mult = 1.0, config = {extra = 1}},
        
        j_fibonacci=        {order = 31,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Fibonacci", pos = {x=1,y=5}, set = "Joker", effect = "Card Mult", cost_mult = 1.0, config = {extra = 4}},
        j_steel_joker=      {order = 32,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 6, name = "Steel Joker", pos = {x=7,y=2}, set = "Joker", effect = "Steel Card Buff", cost_mult = 1.0, config = {extra = 10}},
        j_scary_face=       {order = 33,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Scary Face", pos = {x=2,y=3}, set = "Joker", effect = "Scary Face Cards", cost_mult = 1.0, config = {extra = 20}},
        j_abstract=         {order = 34,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Abstract Joker", pos = {x=3,y=3}, set = "Joker", effect = "Joker Mult", cost_mult = 1.0, config = {extra = 2}},
        ...
        j_pareidolia=       {order = 37,  unlocked = true,  discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = "Pareidolia", pos = {x=6,y=3}, set = "Joker", effect = "All face cards", cost_mult = 1.0, config = {}},
        ...
        j_odd_todd=         {order = 40,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Odd Todd", pos = {x=9,y=3}, set = "Joker", effect = "Odd Card Buff", cost_mult = 1.0, config = {extra = 20}},
        j_scholar=          {order = 41,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Scholar", pos = {x=0,y=4}, set = "Joker", effect = "Ace Buff", cost_mult = 1.0, config = {extra = {mult = 2, chips = 20}}},
        ...
        j_ride_the_bus=     {order = 44,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Ride the Bus", pos = {x=1,y=6}, set = "Joker", effect = "", config = {extra = 1}, unlock_condition = {type = 'discard_custom'}},
        j_space=            {order = 45,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Space Joker", pos = {x=3,y=5}, set = "Joker", effect = "Upgrade Hand chance", cost_mult = 1.0, config = {extra = 5}},
        ...
        j_blackboard=       {order = 48,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 8, name = 'Blackboard', pos = {x = 2, y = 10}, set = 'Joker', config = {extra = 2}},
        j_runner=           {order = 49,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = 'Runner', pos = {x = 3, y = 10}, set = 'Joker', config = {extra = {chips = 20, chip_mod = 10}}},
        ...
        j_dna=              {order = 51,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 10, name = 'DNA', pos = {x = 5, y = 10}, set = 'Joker', config = {}},
        j_splash=           {order = 52,  unlocked = true,  discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 1, cost = 5, name = 'Splash', pos = {x = 6, y = 10}, set = 'Joker', config = {}},
        j_blue_joker=       {order = 53,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = 'Blue Joker', pos = {x = 7, y = 10}, set = 'Joker', config = {extra = 1}},
        j_sixth_sense=      {order = 54,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = 'Sixth Sense', pos = {x = 8, y = 10}, set = 'Joker', config = {extra = 6}},
        ...
        j_hiker=            {order = 56,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = 'Hiker', pos = {x = 0, y = 11}, set = 'Joker', config = {extra = 2}},
        j_faceless=         {order = 57,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = 'Faceless Joker', pos = {x = 1, y = 11}, set = 'Joker', config = {extra = {dollars = 5, faces = 3}}},
        ...
        j_superposition=    {order = 59,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = 'Superposition', pos = {x = 3, y = 11}, set = 'Joker', config = {}},
        j_todo_list=        {order = 60,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = 'To Do List', pos = {x = 4, y = 11}, set = 'Joker', config = {extra = {dollars = 4, poker_hand = 'High Card'}}},

        j_cavendish=        {order = 61, unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = false, rarity = 2, cost = 6, name = "Cavendish", pos = {x=5,y=11}, set = "Joker", cost_mult = 1.0, config = {extra = {odds = 10, Xmult = 3}}, yes_pool_flag = 'gros_michel_extinct'},
        j_card_sharp=       {order = 62, unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Card Sharp", pos = {x=6,y=11}, set = "Joker", cost_mult = 1.0, config = {extra = {Xmult = 2}}},
        ...
        j_square=           {order = 65, unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Square Joker", pos = {x=9,y=11}, set = "Joker", cost_mult = 1.0, config = {extra = {chips = 10, chip_mod = 5}}},
        ...
        j_riff_raff=        {order = 67, unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Riff-raff", pos = {x=1,y=12}, set = "Joker", cost_mult = 1.0, config = {}},
        j_vampire=          {order = 68, unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Vampire",set = "Joker", config = {extra = 0.1, Xmult = 1},  pos = {x=2,y=12}},
        j_shortcut=         {order = 69, unlocked = true,  discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = "Shortcut",set = "Joker", config = {},  pos = {x=3,y=12}},
        j_hologram=         {order = 70,  unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Hologram",set = "Joker", config = {extra = 0.1, Xmult = 1},  pos = {x=4,y=12}, soul_pos = {x=2, y=9},},
        j_vagabond=         {order = 71,  unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Vagabond",set = "Joker", config = {extra = 4}, pos = {x=5,y=12}},
        ...
        j_cloud_9=          {order = 73,  unlocked = true, discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = "Cloud 9",set = "Joker", config = {extra = 2}, pos = {x=7,y=12}},
        j_rocket=           {order = 74,  unlocked = true, discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 1, cost = 6, name = "Rocket",set = "Joker", config = {extra = {dollars = 1, increase = 1}}, pos = {x=8,y=12}},
        j_obelisk=          {order = 75,  unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Obelisk",set = "Joker", config = {extra = 0.5, Xmult = 1}, pos = {x=9,y=12}},
        ...
        j_luchador=         {order = 77,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Luchador",set = "Joker", config = {}, pos = {x=1,y=13}},
        ...
        j_gift=             {order = 79,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Gift Card",set = "Joker", config = {extra = 1}, pos = {x=3,y=13}},
        ...
        j_erosion=          {order = 81,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = false, rarity = 2, cost = 6, name = "Erosion",set = "Joker", config = {extra = 2}, pos = {x=5,y=13}},
        j_reserved_parking= {order = 82,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Reserved Parking",set = "Joker", config = {extra = 1}, pos = {x=6,y=13}},
        j_mail=             {order = 83,  unlocked = true,  discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 1, cost = 4, name = "Mail-In Rebate",set = "Joker", config = {extra = 2}, pos = {x=7,y=13}},
        j_to_the_moon=      {order = 84,  unlocked = true,  discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = "To the Moon",set = "Joker", config = {extra = 1}, pos = {x=8,y=13}},
        ...
        j_fortune_teller=   {order = 86,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Fortune Teller", pos = {x=7,y=5}, set = "Joker", effect = "", config = {extra = 1}},
        ...
        j_drunkard=         {order = 88,  unlocked = true,  discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 1, cost = 4, name = "Drunkard", pos = {x=1,y=1}, set = "Joker", effect = "Discard Size", cost_mult = 1.0, config = {d_size = 2}},
        j_stone=            {order = 89,  unlocked = true,  discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Stone Joker", pos = {x=9,y=0}, set = "Joker", effect = "Stone Card Buff", cost_mult = 1.0, config = {extra = {chips = 20}}},
        ...
        j_lucky_cat=        {order = 91,   unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Lucky Cat",set = "Joker", config = {Xmult = 1, extra = 0.2}, pos = {x=5,y=14}},
        ...
        j_bull=             {order = 93,   unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Bull",set = "Joker", config = {extra = 1}, pos = {x=7,y=14}},
        j_diet_cola=        {order = 94,   unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = false, rarity = 1, cost = 5, name = "Diet Cola",set = "Joker", config = {}, pos = {x=8,y=14}},
        j_trading=          {order = 95,   unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Trading Card",set = "Joker", config = {extra = 5}, pos = {x=9,y=14}},
        j_flash=            {order = 96,   unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Flash Card",set = "Joker", config = {extra = 1, mult = 0}, pos = {x=0,y=15}},
        j_popcorn=          {order = 97,   unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = false, rarity = 1, cost = 5, name = "Popcorn",set = "Joker", config = {mult = 20, extra = 2}, pos = {x=1,y=15}},
        j_trousers=         {order = 98,   unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Spare Trousers",set = "Joker", config = {extra = 1}, pos = {x=4,y=15}},
        j_ancient=          {order = 99,   unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Ancient Joker",set = "Joker", config = {extra = 1.5}, pos = {x=3,y=15}},
        j_ramen=            {order = 100,  unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = false, rarity = 2, cost = 6, name = "Ramen",set = "Joker", config = {Xmult = 2, extra = 0.01}, pos = {x=4,y=15}},
        j_walkie_talkie=    {order = 101,  unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Walkie Talkie",set = "Joker", config = {extra = {chips = 10, mult = 4}}, pos = {x=5,y=15}},
        j_selzer=           {order = 102,  unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = false, rarity = 2, cost = 6, name = "Selzer",set = "Joker", config = {extra = 10}, pos = {x=6,y=15}},
        j_castle=           {order = 103,  unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Castle",set = "Joker", config = {extra = {chips = 0, chip_mod = 2}}, pos = {x=7,y=15}},
        j_smiley=           {order = 104,  unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Smiley Face",set = "Joker", config = {extra = 4}, pos = {x=8,y=15}},
        j_campfire=         {order = 105,  unlocked = true, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Campfire",set = "Joker", config = {extra = 0.5}, pos = {x=9,y=15}},

        j_ticket=           {order = 106,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Golden Ticket", pos = {x=5,y=3}, set = "Joker", effect = "dollars for Gold cards", cost_mult = 1.0, config = {extra = 4},unlock_condition = {type = 'hand_contents', extra = 'Gold'}},
        j_mr_bones=         {order = 107,  unlocked = false, discovered = false, blueprint_compat = false, eternal_compat = false, rarity = 2, cost = 6, name = "Mr. Bones", pos = {x=3,y=4}, set = "Joker", effect = "Prevent Death", cost_mult = 1.0, config = {},unlock_condition = {type = 'c_losses', extra = 5}},
        j_acrobat=          {order = 108,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 8, name = "Acrobat", pos = {x=2,y=1}, set = "Joker", effect = "Shop size", cost_mult = 1.0, config = {extra = 3},unlock_condition = {type = 'c_hands_played', extra = 200}},
        ...
        j_swashbuckler=     {order = 110,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Swashbuckler", pos = {x=9,y=5}, set = "Joker", effect = "Set Mult", cost_mult = 1.0, config = {mult = 1},unlock_condition = {type = 'c_jokers_sold', extra = 20}},
        j_troubadour=       {order = 111,  unlocked = false, discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 1, cost = 5, name = "Troubadour", pos = {x=0,y=2}, set = "Joker", effect = "Hand Size, Plays", cost_mult = 1.0, config = {extra = {h_size = 3, h_plays = -1}}, unlock_condition = {type = 'round_win', extra = 5}},
        j_certificate=      {order = 112,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Certificate", pos = {x=8,y=8}, set = "Joker", effect = "", config = {}, unlock_condition = {type = 'double_gold'}},
        j_smeared=          {order = 113,  unlocked = false, discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 2, cost = 8, name = "Smeared Joker", pos = {x=4,y=6}, set = "Joker", effect = "", config = {}, unlock_condition = {type = 'modify_deck', extra = {count = 3, enhancement = 'Wild Card'}}},
        ...
        j_hanging_chad=     {order = 115,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Hanging Chad", pos = {x=9,y=6}, set = "Joker", effect = "", config = {extra = 1}, unlock_condition = {type = 'round_win', extra = 'High Card'}},
        j_rough_gem=        {order = 116,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 9, name = "Rough Gem", pos = {x=9,y=7}, set = "Joker", effect = "", config = {extra = 2}, unlock_condition = {type = 'modify_deck', extra = {count = 30, suit = 'Diamonds'}}},
        j_bloodstone=       {order = 117,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 9, name = "Bloodstone", pos = {x=0,y=8}, set = "Joker", effect = "", config = {extra = 8}, unlock_condition = {type = 'modify_deck', extra = {count = 30, suit = 'Hearts'}}},
        j_arrowhead=        {order = 118,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 9, name = "Arrowhead", pos = {x=1,y=8}, set = "Joker", effect = "", config = {extra = 30}, unlock_condition = {type = 'modify_deck', extra = {count = 30, suit = 'Spades'}}},
        j_onyx_agate=       {order = 119,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 9, name = "Onyx Agate", pos = {x=2,y=8}, set = "Joker", effect = "", config = {extra = {odds = 3, Xmult = 2}}, unlock_condition = {type = 'modify_deck', extra = {count = 30, suit = 'Clubs'}}},
        j_glass=            {order = 120,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 4, name = "Glass Joker", pos = {x=1,y=3}, set = "Joker", effect = "Glass Card", cost_mult = 1.0, config = {extra = 0.5, Xmult = 1}, unlock_condition = {type = 'modify_deck', extra = {count = 5, enhancement = 'Glass Card'}}},

        j_ring_master=      {order = 121,  unlocked = false, discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = "Ring Master", pos = {x=6,y=5}, set = "Joker", effect = "", config = {}, unlock_condition = {type = 'ante_up', ante = 4}},
        j_flower_pot=       {order = 122,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 8, name = "Flower Pot", pos = {x=0,y=6}, set = "Joker", effect = "", config = {extra = 3}, unlock_condition = {type = 'ante_up', ante = 8}},
        ...
        j_wee=              {order = 124,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 10, name = "Wee Joker", pos = {x=0,y=0}, set = "Joker", effect = "", config = {extra = {chips = 10, chip_mod = 5}}, unlock_condition = {type = 'win', n_rounds = 18}},
        j_merry_andy=       {order = 125,  unlocked = false, discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 3, cost = 10, name = "Merry Andy", pos = {x=8,y=0}, set = "Joker", effect = "", cost_mult = 1.0, config = {extra = 10}, unlock_condition = {type = 'win', n_rounds = 12}},
        j_oops=             {order = 126,  unlocked = false, discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = "Oops! All 6s", pos = {x=5,y=6}, set = "Joker", effect = "", config = {}, unlock_condition = {type = 'chip_score', chips = 10000}},
        ...
        j_seeing_double=    {order = 128,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Seeing Double", pos = {x=4,y=4}, set = "Joker", effect = "X1.5 Mult club 7", cost_mult = 1.0, config = {Xmult = 1.5},unlock_condition = {type = 'hand_contents', extra = 'four 7 of Clubs'}},
        j_matador=          {order = 129,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 8, name = "Matador", pos = {x=4,y=5}, set = "Joker", effect = "", config = {extra = 10}, unlock_condition = {type = 'round_win'}},
        j_hit_the_road=     {order = 130,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 10, name = "Hit the Road", pos = {x=8,y=5}, set = "Joker", effect = "Jack Discard Effect", cost_mult = 1.0, config = {extra = 0.5}, unlock_condition = {type = 'discard_custom'}},
        j_duo=              {order = 131,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 9, name = "The Duo", pos = {x=5,y=4}, set = "Joker", effect = "X1.5 Mult", cost_mult = 1.0, config = {Xmult = 1.5, type = 'Pair'}, unlock_condition = {type = 'win_no_hand', extra = 'Pair'}},
        j_trio=             {order = 132,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 9, name = "The Trio", pos = {x=6,y=4}, set = "Joker", effect = "X2 Mult", cost_mult = 1.0, config = {Xmult = 2, type = 'Three of a Kind'}, unlock_condition = {type = 'win_no_hand', extra = 'Three of a Kind'}},
        j_family=           {order = 133,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 9, name = "The Family", pos = {x=7,y=4}, set = "Joker", effect = "X3 Mult", cost_mult = 1.0, config = {Xmult = 3, type = 'Four of a Kind'}, unlock_condition = {type = 'win_no_hand', extra = 'Four of a Kind'}},
        j_order=            {order = 134,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 9, name = "The Order", pos = {x=8,y=4}, set = "Joker", effect = "X3 Mult", cost_mult = 1.0, config = {Xmult = 3, type = 'Straight'}, unlock_condition = {type = 'win_no_hand', extra = 'Straight'}},
        j_tribe=            {order = 135,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 9, name = "The Tribe", pos = {x=9,y=4}, set = "Joker", effect = "X3 Mult", cost_mult = 1.0, config = {Xmult = 2, type = 'Flush'}, unlock_condition = {type = 'win_no_hand', extra = 'Flush'}},
        
        j_stuntman=         {order = 136,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Stuntman", pos = {x=8,y=6}, set = "Joker", effect = "", config = {extra = {h_size = 2, chip_mod = 200}}, unlock_condition = {type = 'chip_score', chips = 100000000}},
        ...
        j_satellite=        {order = 139,  unlocked = false, discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 3, cost = 8, name = "Satellite", pos = {x=8,y=7}, set = "Joker", effect = "", config = {extra = 2}, unlock_condition = {type = 'money', extra = 400}},
        ...
        j_drivers_license=  {order = 141,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Driver's License", pos = {x=0,y=7}, set = "Joker", effect = "", config = {extra = 2}, unlock_condition = {type = 'modify_deck', extra = {count = 16, tally = 'total'}}},
        j_cartomancer=      {order = 142,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 2, cost = 8, name = "Cartomancer", pos = {x=7,y=3}, set = "Joker", effect = "Tarot Buff", cost_mult = 1.0, config = {}, unlock_condition = {type = 'discover_amount', tarot_count = 22}},
        j_astronomer=       {order = 143,  unlocked = false, discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 2, cost = 8, name = "Astronomer", pos = {x=2,y=7}, set = "Joker", effect = "", config = {}, unlock_condition = {type = 'discover_amount', planet_count = 11}},
        j_burnt=            {order = 144,  unlocked = false, discovered = false, blueprint_compat = false, eternal_compat = true, rarity = 3, cost = 8, name = "Burnt Joker", pos = {x=3,y=7}, set = "Joker", effect = "", config = {h_size = 0, extra = 4}, unlock_condition = {type = 'c_cards_sold', extra = 50}},
        j_bootstraps=       {order = 145,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 3, cost = 10, name = "Bootstraps", pos = {x=9,y=8}, set = "Joker", effect = "", config = {extra = {mult = 1, dollars = 5}}, unlock_condition = {type = 'modify_jokers', extra = {polychrome = true, count = 2}}},
        ...
        j_triboulet=        {order = 147,  unlocked = false, discovered = false, blueprint_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "Triboulet", pos = {x=4,y=8}, soul_pos = {x=4, y=9}, set = "Joker", effect = "", config = {extra = 1.5}, unlock_condition = {type = '', extra = '', hidden = true}},
        ...
        --Tarots
        c_fool=             {order = 1,     discovered = false, cost = 4, consumeable = true, name = "The Fool", pos = {x=0,y=0}, set = "Tarot", effect = "Disable Blind Effect", cost_mult = 1.0, config = {}},
        c_magician=         {order = 2,     discovered = false, cost = 4, consumeable = true, name = "The Magician", pos = {x=1,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, config = {mod_conv = 'm_lucky', max_highlighted = 1}},
        c_high_priestess=   {order = 3,     discovered = false, cost = 4, consumeable = true, name = "The High Priestess", pos = {x=2,y=0}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, config = {planets = 2}},
        c_empress=          {order = 4,     discovered = false, cost = 4, consumeable = true, name = "The Empress", pos = {x=3,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, config = {mod_conv = 'm_mult', max_highlighted = 2}},
        c_emperor=          {order = 5,     discovered = false, cost = 4, consumeable = true, name = "The Emperor", pos = {x=4,y=0}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, config = {tarots = 2}},
        c_heirophant=       {order = 6,     discovered = false, cost = 4, consumeable = true, name = "The Hierophant", pos = {x=5,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, config = {mod_conv = 'm_bonus', max_highlighted = 2}},
        c_lovers=           {order = 7,     discovered = false, cost = 4, consumeable = true, name = "The Lovers", pos = {x=6,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, config = {mod_conv = 'm_wild', max_highlighted = 1}},
        c_chariot=          {order = 8,     discovered = false, cost = 4, consumeable = true, name = "The Chariot", pos = {x=7,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, config = {mod_conv = 'm_steel', max_highlighted = 1}},
        c_justice=          {order = 9,     discovered = false, cost = 4, consumeable = true, name = "Justice", pos = {x=8,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, config = {mod_conv = 'm_glass', max_highlighted = 1}},
        c_hermit=           {order = 10,    discovered = false, cost = 4, consumeable = true, name = "The Hermit", pos = {x=9,y=0}, set = "Tarot", effect = "Dollar Doubler", cost_mult = 1.0, config = {extra = 20}},
        c_wheel_of_fortune= {order = 11,    discovered = false, cost = 4, consumeable = true, name = "The Wheel of Fortune", pos = {x=0,y=1}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, config = {extra = 5}},
        c_strength=         {order = 12,    discovered = false, cost = 4, consumeable = true, name = "Strength", pos = {x=1,y=1}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, config = {mod_conv = 'up_rank', max_highlighted = 2}},
        c_hanged_man=       {order = 13,    discovered = false, cost = 4, consumeable = true, name = "The Hanged Man", pos = {x=2,y=1}, set = "Tarot", effect = "Card Removal", cost_mult = 1.0, config = {remove_card = true, max_highlighted = 2}},
        c_death=            {order = 14,    discovered = false, cost = 4, consumeable = true, name = "Death", pos = {x=3,y=1}, set = "Tarot", effect = "Card Conversion", cost_mult = 1.0, config = {mod_conv = 'card', max_highlighted = 2, min_highlighted = 2}},
        c_temperance=       {order = 15,    discovered = false, cost = 4, consumeable = true, name = "Temperance", pos = {x=4,y=1}, set = "Tarot", effect = "Joker Payout", cost_mult = 1.0, config = {extra = 50}},
        c_devil=            {order = 16,    discovered = false, cost = 4, consumeable = true, name = "The Devil", pos = {x=5,y=1}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, config = {mod_conv = 'm_gold', max_highlighted = 1}},
        c_tower=            {order = 17,    discovered = false, cost = 4, consumeable = true, name = "The Tower", pos = {x=6,y=1}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, config = {mod_conv = 'm_stone', max_highlighted = 1}},
        c_star=             {order = 18,    discovered = false, cost = 4, consumeable = true, name = "The Star", pos = {x=7,y=1}, set = "Tarot", effect = "Suit Conversion", cost_mult = 1.0, config = {suit_conv = 'Diamonds', max_highlighted = 3}},
        c_moon=             {order = 19,    discovered = false, cost = 4, consumeable = true, name = "The Moon", pos = {x=8,y=1}, set = "Tarot", effect = "Suit Conversion", cost_mult = 1.0, config = {suit_conv = 'Clubs', max_highlighted = 3}},
        c_sun=              {order = 20,    discovered = false, cost = 4, consumeable = true, name = "The Sun", pos = {x=9,y=1}, set = "Tarot", effect = "Suit Conversion", cost_mult = 1.0, config = {suit_conv = 'Hearts', max_highlighted = 3}},
        c_judgement=        {order = 21,    discovered = false, cost = 4, consumeable = true, name = "Judgement", pos = {x=0,y=2}, set = "Tarot", effect = "Random Joker", cost_mult = 1.0, config = {}},
        c_world=            {order = 22,    discovered = false, cost = 4, consumeable = true, name = "The World", pos = {x=1,y=2}, set = "Tarot", effect = "Suit Conversion", cost_mult = 1.0, config = {suit_conv = 'Spades', max_highlighted = 3}},

        --Planets
        c_mercury=          {order = 1,    discovered = false, cost = 4, consumeable = true, freq = 1, name = "Mercury", pos = {x=0,y=3}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {hand_type = 'Pair'}},
        c_venus=            {order = 2,    discovered = false, cost = 4, consumeable = true, freq = 1, name = "Venus", pos = {x=1,y=3}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {hand_type = 'Three of a Kind'}},
        c_earth=            {order = 3,    discovered = false, cost = 4, consumeable = true, freq = 1, name = "Earth", pos = {x=2,y=3}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {hand_type = 'Full House'}},
        c_mars=             {order = 4,    discovered = false, cost = 4, consumeable = true, freq = 1, name = "Mars", pos = {x=3,y=3}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {hand_type = 'Four of a Kind'}},
        c_jupiter=          {order = 5,    discovered = false, cost = 4, consumeable = true, freq = 1, name = "Jupiter", pos = {x=4,y=3}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {hand_type = 'Flush'}},
        c_saturn=           {order = 6,    discovered = false, cost = 4, consumeable = true, freq = 1, name = "Saturn", pos = {x=5,y=3}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {hand_type = 'Straight'}},
        c_uranus=           {order = 7,    discovered = false, cost = 4, consumeable = true, freq = 1, name = "Uranus", pos = {x=6,y=3}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {hand_type = 'Two Pair'}},
        c_neptune=          {order = 8,    discovered = false, cost = 4, consumeable = true, freq = 1, name = "Neptune", pos = {x=7,y=3}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {hand_type = 'Straight Flush'}},
        c_pluto=            {order = 9,    discovered = false, cost = 4, consumeable = true, freq = 1, name = "Pluto", pos = {x=8,y=3}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {hand_type = 'High Card'}},
        c_planet_x=         {order = 10,   discovered = false, cost = 4, consumeable = true, freq = 1, name = "Planet X", pos = {x=9,y=2}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {hand_type = 'Five of a Kind', softlock = true}},
        c_ceres=            {order = 11,   discovered = false, cost = 4, consumeable = true, freq = 1, name = "Ceres", pos = {x=8,y=2}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {hand_type = 'Flush House', softlock = true}},
        c_eris=             {order = 12,   discovered = false, cost = 4, consumeable = true, freq = 1, name = "Eris", pos = {x=3,y=2}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {hand_type = 'Flush Five', softlock = true}},
        ...
        v_reroll_surplus=   {order = 7,    discovered = false, unlocked = true , available = true, cost = 10, name = "Reroll Surplus", pos = {x=0,y=2}, set = "Voucher", config = {extra = 1}},
        ...
        v_tarot_merchant=   {order = 17,     discovered = false, unlocked = true , available = true, cost = 10, name = "Tarot Merchant", pos = {x=1,y=0}, set = "Voucher", config = {extra = 2}},
        v_planet_merchant=  {order = 19,     discovered = false, unlocked = true , available = true, cost = 10, name = "Planet Merchant", pos = {x=2,y=0}, set = "Voucher", config = {extra = 2}},
        ...
        v_overstock_plus=   {order = 2,     discovered = false, unlocked = false, available = true, cost = 20, name = "Overstock Plus", pos = {x=0,y=1}, set = "Voucher", config = {}, requires = {'v_overstock_norm'},unlock_condition = {type = 'c_shop_dollars_spent', extra = 2500}},
        v_liquidation=      {order = 4,     discovered = false, unlocked = false, available = true, cost = 20, name = "Liquidation", pos = {x=3,y=1}, set = "Voucher", config = {extra = 50}, requires = {'v_clearance_sale'},unlock_condition = {type = 'run_redeem', extra = 10}},
        v_glow_up=          {order = 6,    discovered = false, unlocked = false, available = true, cost = 20, name = "Glow Up", pos = {x=4,y=1}, set = "Voucher", config = {extra = 4}, requires = {'v_hone'},unlock_condition = {type = 'have_edition', extra = 5}},
        v_reroll_glut=      {order = 8,    discovered = false, unlocked = false, available = true, cost = 20, name = "Reroll Glut", pos = {x=0,y=3}, set = "Voucher", config = {extra = 1}, requires = {'v_reroll_surplus'},unlock_condition = {type = 'c_shop_rerolls', extra = 100}},
        v_omen_globe=       {order = 10,    discovered = false, unlocked = false, available = true, cost = 20, name = "Omen Globe", pos = {x=2,y=3}, set = "Voucher", config = {extra = 4}, requires = {'v_crystal_ball'},unlock_condition = {type = 'c_tarot_reading_used', extra = 25}},
        v_observatory=      {order = 12,    discovered = false, unlocked = false, available = true, cost = 20, name = "Observatory", pos = {x=3,y=3}, set = "Voucher", config = {extra = 1.5}, requires = {'v_telescope'},unlock_condition = {type = 'c_planetarium_used', extra = 25}},
        v_nacho_tong=       {order = 14,    discovered = false, unlocked = false, available = true, cost = 20, name = "Nacho Tong", pos = {x=5,y=1}, set = "Voucher", config = {extra = 1}, requires = {'v_grabber'},unlock_condition = {type = 'c_cards_played', extra = 2500}},
        v_recyclomancy=     {order = 16,    discovered = false, unlocked = false, available = true, cost = 20, name = "Recyclomancy", pos = {x=6,y=1}, set = "Voucher", config = {extra = 1}, requires = {'v_wasteful'},unlock_condition = {type = 'c_cards_discarded', extra = 2500}},
        v_tarot_tycoon=     {order = 18,     discovered = false, unlocked = false, available = true, cost = 20, name = "Tarot Tycoon", pos = {x=1,y=1}, set = "Voucher", config = {extra = 4}, requires = {'v_tarot_merchant'},unlock_condition = {type = 'c_tarots_bought', extra = 50}},
        v_planet_tycoon=    {order = 20,     discovered = false, unlocked = false, available = true, cost = 20, name = "Planet Tycoon", pos = {x=2,y=1}, set = "Voucher", config = {extra = 4}, requires = {'v_planet_merchant'},unlock_condition = {type = 'c_planets_bought', extra = 50}},
        v_money_tree=       {order = 22,    discovered = false, unlocked = false, available = true, cost = 20, name = "Money Tree", pos = {x=1,y=3}, set = "Voucher", config = {extra = 100}, requires = {'v_seed_money'},unlock_condition = {type = 'interest_streak', extra = 10}},
        v_antimatter=       {order = 24,    discovered = false, unlocked = false, available = true, cost = 20, name = "Antimatter", pos = {x=7,y=1}, set = "Voucher", config = {extra = 15}, requires = {'v_blank'},unlock_condition = {type = 'blank_redeems', extra = 10}},
        v_illusion=         {order = 26,    discovered = false, unlocked = false, available = true, cost = 20, name = "Illusion", pos = {x=4,y=3}, set = "Voucher", config = {extra = 4}, requires = {'v_magic_trick'},unlock_condition = {type = 'c_playing_cards_bought', extra = 20}},
        v_petroglyph=       {order = 28,    discovered = false, unlocked = false, available = true, cost = 20, name = "Petroglyph", pos = {x=5,y=3}, set = "Voucher", config = {extra = 2}, requires = {'v_hieroglyph'},unlock_condition = {type = 'ante_up', ante = 16, extra = 16}},
        v_retcon=           {order = 30,    discovered = false, unlocked = false, available = true, cost = 20, name = "Retcon", pos = {x=6,y=3}, set = "Voucher", config = {}, requires = {'v_directors_cut'},unlock_condition = {type = 'blind_discoveries', extra = 25}},
        v_palette=          {order = 32,    discovered = false, unlocked = false, available = true, cost = 20, name = "Palette", pos = {x=7,y=3}, set = "Voucher", config = {extra = 1}, requires = {'v_paint_brush'},unlock_condition = {type = 'min_hand_size', extra = 5}},
        ...
        b_metal=            {name = "Metal Deck",       stake = 1, unlocked = false,order = 8, pos =  {x=6,y=2}, set = "Back", config = {start_steel = 6}, unlock_condition = {type = 'win_deck', deck = 'b_yellow'}},
        ...
        b_rocky=            {name = "Rocky Deck",       stake = 1, unlocked = false,order = 11, pos = {x=3,y=4}, set = "Back", config = {start_stone = 13}, unlock_condition = {type = 'win_stake', stake = 2}},
        b_braided=          {name = "Braided Deck",     stake = 1, unlocked = false,order = 12, pos = {x=4,y=3}, set = "Back", config = {first_used_hand_level = 2}, unlock_condition = {type = 'win_stake', stake=3}},
        ...
        m_bonus =   {max = 500, order = 2, name = "Bonus", set = "Enhanced", pos = {x=1,y=1}, effect = "Bonus Card", label = "Bonus Card", config = {bonus=20}},
        m_mult =    {max = 500, order = 3, name = "Mult", set = "Enhanced", pos = {x=2,y=1}, effect = "Mult Card", label = "Mult Card", config = {mult = 3}},
        ...
        m_steel =   {max = 500, order = 6, name = "Steel Card", set = "Enhanced", pos = {x=6,y=1}, effect = "Steel Card", label = "Steel Card", config = {h_mult = 5}},
        ...
        e_foil =       {order = 2,  unlocked = true, discovered = false, name = "Foil", pos = {x=0,y=0}, atlas = 'Joker', set = "Edition", config = {extra = 30}},
        ...
        p_spectral_normal_1 =       {order = 29, discovered = false, name = "Spectral Pack", weight = 0.4, kind = 'Spectral', cost = 4, pos = {x=0,y=4}, atlas = 'Booster', set = 'Booster', config = {extra = 2, choose = 1}},
        p_spectral_normal_2 =       {order = 30, discovered = false, name = "Spectral Pack", weight = 0.4, kind = 'Spectral', cost = 4, pos = {x=1,y=4}, atlas = 'Booster', set = 'Booster', config = {extra = 2, choose = 1}},
        p_spectral_jumbo_1 =        {order = 31, discovered = false, name = "Jumbo Spectral Pack", weight = 0.4, kind = 'Spectral', cost = 6, pos = {x=2,y=4}, atlas = 'Booster', set = 'Booster', config = {extra = 4, choose = 1}},
        p_spectral_mega_1 =         {order = 32, discovered = false, name = "Mega Spectral Pack", weight = 0.1, kind = 'Spectral', cost = 8, pos = {x=3,y=4}, atlas = 'Booster', set = 'Booster', config = {extra = 4, choose = 2}},
        ...
        p_buffoon_normal_1 =        {order = 25, discovered = false, name = "Buffoon Pack", weight = 2, kind = 'Buffoon', cost = 4, pos = {x=0,y=8}, atlas = 'Booster', set = 'Booster', config = {extra = 2, choose = 1}},
        p_buffoon_normal_2 =        {order = 26, discovered = false, name = "Buffoon Pack", weight = 2, kind = 'Buffoon', cost = 4, pos = {x=1,y=8}, atlas = 'Booster', set = 'Booster', config = {extra = 2, choose = 1}},
        p_buffoon_jumbo_1 =         {order = 27, discovered = false, name = "Jumbo Buffoon Pack", weight = 2, kind = 'Buffoon', cost = 6, pos = {x=2,y=8}, atlas = 'Booster', set = 'Booster', config = {extra = 4, choose = 1}},
        p_buffoon_mega_1 =          {order = 28, discovered = false, name = "Mega Buffoon Pack", weight = 0.5, kind = 'Buffoon', cost = 8, pos = {x=3,y=8}, atlas = 'Booster', set = 'Booster', config = {extra = 4, choose = 2}},
    ...
    for k, v in pairs(self.P_CENTERS) do
        if not v.wip and not v.demo then 
            ...
            if v.discovered and meta.alerted[k] or v.set == 'Back' then 
                v.alerted = true
...
function Game:set_language()
    if not self.LANGUAGES then 
        ...
        self.LANGUAGES = {
            ['en-us'] = {font = 1, label = "English", key = 'en-us'},
            ['de'] = {font = 1, label = "Deutsch", key = 'de'},
            ['es-mx'] = {font = 1, label = "Español", key = 'es-mx'},
            ['fr'] = {font = 1, label = "Français", key = 'fr'},
            ['id'] = {font = 1, label = "Bahasa Indonesia", key = 'id'},
            ['it'] = {font = 1, label = "Italiano", key = 'it'},
            ['ja'] = {font = 5, label = "日本語", key = 'ja'},
            ['ko'] = {font = 4, label = "한국인", key = 'ko'},
            ['nl'] = {font = 1, label = "Nederlands", key = 'nl'},
            ['pl'] = {font = 1, label = "Polski", key = 'pl'},
            ['pt-br'] = {font = 1, label = "Português", key = 'pt-br'},
            ['ru'] = {font = 6, label = "Русский", key = 'ru'},
            ['zh-cn'] = {font = 2, label = "简体中文", key = 'zh-cn'},
            ['zh-tw'] = {font = 3, label = "繁體中文", key = 'zh-tw'},
            ['tr'] = {font = 1, label = "Türkçe", key = 'tr'},
        ...
        self.FONTS = {
            ...
            {file = "resources/fonts/NotoSans-Bold.ttf", render_scale = self.TILESIZE*7, TEXT_HEIGHT_SCALE = 0.8, TEXT_OFFSET = {x=0,y=-30}, FONTSCALE = 0.12, squish = 1, DESCSCALE = 1},
...
function Game:main_menu(change_context) --True if main menu is accessed from the splash screen, false if it is skipped or accessed from the game
    ...
    G.FUNCS.change_shadows{to_val = G.SETTINGS.GRAPHICS.shadows}
...
function Game:init_game_object()
    ...
    return {
        ...
        hands = {
            ["Flush Five"] =        {visible = false,   order = 1, mult = 14,  chips = 150, s_mult = 14,  s_chips = 150, level = 1, l_mult = 3, l_chips = 35, played = 0, played_this_round = 0, example = {{'S_A', true},{'S_A', true},{'S_A', true},{'S_A', true},{'S_A', true}}},
            ["Flush House"] =       {visible = false,   order = 2, mult = 12,  chips = 120, s_mult = 12,  s_chips = 120, level = 1, l_mult = 3, l_chips = 30, played = 0, played_this_round = 0, example = {{'D_7', true},{'D_7', true},{'D_7', true},{'D_4', true},{'D_4', true}}},
            ["Five of a Kind"] =    {visible = false,   order = 3, mult = 10,  chips = 100, s_mult = 10,  s_chips = 100, level = 1, l_mult = 3, l_chips = 25, played = 0, played_this_round = 0, example = {{'S_A', true},{'H_A', true},{'H_A', true},{'C_A', true},{'D_A', true}}},
            ...
            ["Four of a Kind"] =    {visible = true,    order = 5, mult = 5,   chips = 60,  s_mult = 5,   s_chips = 60,  level = 1, l_mult = 2, l_chips = 25, played = 0, played_this_round = 0, example = {{'S_J', true},{'H_J', true},{'C_J', true},{'D_J', true},{'C_3', false}}},
            ["Full House"] =        {visible = true,    order = 6, mult = 4,   chips = 40,  s_mult = 4,   s_chips = 40,  level = 1, l_mult = 2, l_chips = 20, played = 0, played_this_round = 0, example = {{'H_K', true},{'C_K', true},{'D_K', true},{'S_2', true},{'D_2', true}}},
            ["Flush"] =             {visible = true,    order = 7, mult = 4,   chips = 35,  s_mult = 4,   s_chips = 35,  level = 1, l_mult = 2, l_chips = 20, played = 0, played_this_round = 0, example = {{'H_A', true},{'H_K', true},{'H_T', true},{'H_5', true},{'H_4', true}}},
...
function Game:start_run(args)
    ...
    if not saveTable then 
        ...
        if self.GAME.stake >= 4 then self.GAME.starting_params.discards = self.GAME.starting_params.discards - 1 end
        if self.GAME.stake >= 5 then self.GAME.modifiers.enable_eternals_in_shop = true end
    ...
    if saveTable then 
        ...
        for k, v in pairs(cardAreas) do
            ...
            else print("ERROR LOADING GAME: Card area '"..k.."' not instantiated before load") end
        end
...
function Game:draw()
    ...
    if not self.OVERLAY_MENU then 
        timer_checkpoint('primatives', 'draw')
    for k, v in pairs(self.I.UIBOX) do
        if not v.attention_text and not v.parent and v ~= self.OVERLAY_MENU and v ~= self.screenwipe and v ~= self.OVERLAY_TUTORIAL and v ~= self.debug_tools and v ~= self.online_leaderboard then 
            love.graphics.push()
            v:translate_container()
            v:draw()
            love.graphics.pop()
    ...
    for k, v in pairs(self.I.UIBOX) do
        if v.attention_text and v ~= self.debug_tools and v ~= self.online_leaderboard  then 
            love.graphics.push()
            v:translate_container()
            v:draw()
            love.graphics.pop()
    ...
    if self.OVERLAY_TUTORIAL then
        ...
        if self.OVERLAY_MENU ~= self.CONTROLLER.dragging.target then
            love.graphics.push()
...
love.graphics.pop()
    ...
    if not _RELEASE_MODE and not G.video_control and G.F_VERBOSE then 
        ...
        love.graphics.print((G.DEBUG_VALUE or ''), 200, 10)
...
function Game:update_selecting_hand(dt)
    if not self.deck_preview and not G.OVERLAY_MENU and (
        (self.deck and self.deck.cards[1] and self.deck.cards[1].states.collide.is and (not self.deck.cards[1].states.drag.is or self.CONTROLLER.HID.touch)) or 
        ...
        self.E_MANAGER:add_event(Event({
            ...
            blockable = false,
            func = function()
                if self.deck_preview and not ((self.deck and self.deck.cards[1] and self.deck.cards[1].states.collide.is) or G.CONTROLLER.held_buttons.triggerleft) then 
        ...
        G.E_MANAGER:add_event(Event({
            ...
            func = function()
                ...
                G.E_MANAGER:add_event(Event({
                    trigger = 'immediate',
                    func = function()
                        if G.round_eval.alignment.offset.y ~= -7.2 then
                            G.round_eval.alignment.offset.y = -7.2
                        else
...
function Game:update_game_over(dt)
    if not G.STATE_COMPLETE then
        ...
        if G.GAME.round_resets.ante <= G.GAME.win_ante then inc_career_stat('c_losses', 1) end

        play_sound('negative', 0.5, 5)
        play_sound('whoosh2', 0.9, 5)
