    ...
    descriptions={
        Back={
            ...
            b_anaglyph={
                ...
                text={
                    "Her",
                    "{C:attention}Usta Bahisi{}, yendiğinde bir",
...
dictionary={
            ...
            b_discard="Çıkar",
            b_editions="Edisyonlar",
            b_endless="Sınırsız Mod",
            b_enhanced_cards="Geliştirilmiş Kartlar",
            ...
            b_set_pixel_smoothing="Pixel Art Yumuşatması",
            ...
            k_enter_seed="Seed Girin",
            k_enter_text="Metin Girin",
            k_eroded_ex="Aşındı!",
            k_extinct_ex="Nesli Tükendi!",
            k_face_cards="Resimli Kartlar",
            k_game_modifiers="Oyun Düzenleyiciler",
            k_gold="Altın",
            ...
            ml_edition_seal_enhancement_explanation={
                ...
                "Geliştirme, Edidsyon, ve Mühür bulunabilir.",
            },
            ml_eternal={
                "Ebedi",
                "Satılamaz veya",
            ...
            ph_1_level="+1 Seviye",
            ph_4_7_of_clubs="dört Sineğin 7si",
            ...
            ph_boss_disabled="Usta Geçersiz Kılındı!",
            ph_choose_blind_1="Sonraki",
            ph_choose_blind_2="Bahisini seç",
            ...
            ph_defeat_the_boss="Usta Bahisi Yen",
            ...
            ph_display_stickers="Oyun içerisinde Stake çıkartmalarını göster",
            ph_game_over="OYUN BİTTİ",
            ph_improve_run="Elini geliştir!",
            ph_most_played="(en çok oynanan el)",
            ph_mr_bones="Bay Kemikler tarafından kurtarıldın",
            ph_no_boss_active="aktif usta yok",
            ...
            ph_score_times_rerolled="Kaç Değişim Yapıldı",
            ph_select_challenge="Bir Mücadele Seç",
            ph_sneak_peek="Ön Gösterim",
            ph_stat_consumable="Bu kardın kullanılma sayısı",
        ...
        high_scores={
            boss_streak="Ardarda En Çok Usta",
            ...
            win_streak="Ardarda En Çok Kazanma",
        },
        labels={
        ...
        poker_hand_descriptions={
            ...
            ["Flush Five"]={
                "Aynı sayı ve sembollü 5 kart",
            },
            ["Flush House"]={
                "Bir Set ve aynı sembollere",
                "sahip olan bir Per",
            },
            ["Four of a Kind"]={
                "Aynı sembollü 4 kart. Skorlanmayan",
                "bir kart ile oynanabilirler",
            },
            ["Full House"]={
                "Bir set ve bir Per",
            },
            ["High Card"]={
                "Oynanılan poker eli buradaki diğer poker elleriyle ",
                "uyuşmuyorsa, sadece en yüksek sayılı kart skorlar",
            },
            Pair={
                "Aynı sembollü 2 kart. Skorlanmayan",
                "3 kart ile oynanabilirler",
            },
            ["Royal Flush"]={
                "Üst üste (peş peşe sayılarla) aynı",
                "sembollü 5 kart",
            },
            Straight={
                "Üst üste (peş peşe sayılarla) 5 kart",
            },
            ["Straight Flush"]={
                "Üst üste (peş peşe sayılarla) aynı",
                "sembollü 5 kart",
            ...
            ["Three of a Kind"]={
                 "Aynı sembollü 3 kart. Skorlanmayan",
                "2 kart ile oynanabilirler",
            },
            ["Two Pair"]={
                "Farklı sayılara sahip olan 2 Per, ",
                "skorlanmayan 1 kart ile oynanabilirler",
            },
        },
        poker_hands={
            ["Five of a Kind"]="Beş Benzer",
            Flush="Kent",
            ["Flush Five"]="Renkli Kent",
            ["Flush House"]="Ful Kent",
        ...
        tutorial={
            ...
            bb_2={
                "Ya da {C:attention} Etiket{} almak için",
                "{C:attention}geçmeyi seç! Her",
                "{C:attention}Etiket{}in farklı bir efekti vardır.",
            },
            bb_3={
                "Ama Usta Bahis{}e",
                "dikkat et.",
            ...
            fh_2={
                "Her {C:attention}Poker eli{} temel bir",
                "{C:blue}Fiş miktarı kazandırır.",
                "bu da {C:red}Katlama ile çarpılır.",
            },
            fh_3={
            ...
            fh_4_touch={
                "Ayrıca kartlar da sana",
                "{C:blue}Fiş{} kazandırır,",
                "tıklayıp basılı tutarak görebilirsin!",
            },
            fh_5={
            ...
            fh_6={
                "Ayrıca daha da güçlü eller",
                "yapmayı denemek için",
                "{C:attention}5{} karda kadar seçip",
                "{C:red}'Çıkar'{} yapabilirsin",
            },
            fh_7={
                "Dikkat et! {C:blue}El ",
                "sayın ve de C:red}Çıkarma{} ",
                "sayın her tur sınırlıdır.",
            },
            fh_8={
                "Bu eli kazanmak için,",
                "{C:blue}Ellerin bitmeden",
                "{C:attention}300 Fiş{} kazan.",
                "İyi şanslar!",
            },
            s_1={
                "İyi işti! Artık {C:money}Parayla{}",
                "{E:1}dolu{} olduğun için,",
                "{C:attention}Mağaza'dan yeni",
                "kartlar alabilirsin.",
            },
            s_10={
            ...
            s_3={
                "Bu, oyununa ekleyebileceğin",
                "{C:attention}Jokerlerden{} biri.",
                "Her {C:attention}Joker",
                "farklı bir şey yapar.",
            },
            s_4={
                "Bu oynadığın her ele",
                "{C:red}+4 Katlama{} ekler!",
            },
            s_5={
                "Seçici ol. Bir seferde",
                "sadece {C:attention}5 Joker{}",
                "kardı taşıyabilirsin.",
            },
            s_6={
                "Şimdi diğer kardı",
                "{C:attention}Mağaza'dan al.",
            },
            s_7={
                "Bu {C:tarot}Tarot{} kardı bir",
                "{C:attention}kullanılabilendir.{}.",
                "Bu senin oynama kartlarını geliştirecek!",
                "Bunu elinde tut!",
            },
            s_8={
            ...
            s_9={
                "Eğer yeterince para biriktirirsen,",
                "Bir {C:attention}Kupon{} alabilirsin.",
                "{C:attention}Kuponlar{} pasif olarak",
                "oyununu geliştirir!",
            },
            sb_1={
                "Selam! Benim adım",
            ...
            sb_2={
                "Senin hedefin",
                "düşman {C:attention}Bahisi",
                "yenmek için {C:blue}Fiş{} kazanmak.",
            },
            sb_3={
                "Bu bir {C:blue}Küçük Bahistir{},",
                "bunu yenmek için sadece",
                "{C:attention}300 Fiş{} skorlaman gerek.",
            },
            sb_4={
                "Turu başlatmak için",
        ...
        v_dictionary={
            ...
            interest="#1# Her $#2# dolarda bir faiz (#3# max)",
