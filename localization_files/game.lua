...
function Game:set_language()
    if not self.LANGUAGES then 
        ...
        self.LANGUAGES = {
            ...
            ['tr'] = {font = 1, label = "Türkçe", key = 'tr', omit = false, beta = true, button = "Dil Geri Bildirimi", warning = {'Bu dil henüz Beta sürümündedir. Bize yardımcı olmak için','lütfen geri bildirim tuşuna tıklayın.', 'Doğrulamak için tekrar tıkla'}},
