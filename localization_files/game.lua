...
function Game:set_language()
    if not self.LANGUAGES then 
        ...
        self.LANGUAGES = {
            ...
            ['tr'] = {font = 1, label = "Türkçe", key = 'tr', omit = false, beta = true, button = "Dil Geri Bildirimi", warning = {'Bu dil henüz Beta sürümündedir. Geri bildirim tuşuna tıklayarak','bize yardımcı olabilir ve çeviriyi geliştirebilirsiniz.', 'Doğrulamak için tekrar tıkla'}},
